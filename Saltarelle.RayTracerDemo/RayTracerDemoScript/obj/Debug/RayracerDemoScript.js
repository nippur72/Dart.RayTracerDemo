...
$simpleray_$RayTracer.$main = function() {
	...
	for (var i = 0; i < 30; i++) {
		...
		$simpleray_$RayTracer.$objects.add(s);
	}
	...
	$simpleray_$RayTracer.$objects.add(floor);
	// add some lights
	$simpleray_$RayTracer.$lights.add(new $simpleray_Light(new $simpleray_Vector3f(2, 0, 0)));
	$simpleray_$RayTracer.$lights.add(new $simpleray_Light(new $simpleray_Vector3f(0, 10, 7.5)));
...
$simpleray_$RayTracer.$reportSpeed = function(msPerPixel) {
	...
	$simpleray_$RayTracer.$speedSamples.add(msPerPixel);
	var average = 0;
	...
	document.getElementById('speed').innerHTML = String.format('min: {0:F3} ms/pixel, max: {1:F3} ms/pixel, avg: {2:F3} ms/pixel', $simpleray_$RayTracer.$minSpeed, $simpleray_$RayTracer.$maxSpeed, average);
};
...
Type.registerClass(null, 'simpleray.$RayTracer', $simpleray_$RayTracer, Object);
Type.registerClass(global, 'simpleray.Light', $simpleray_Light, Object);
Type.registerClass(global, 'simpleray.Ray', $simpleray_Ray, Object);
Type.registerClass(global, 'simpleray.RTObject', $simpleray_RTObject, Object);
Type.registerClass(global, 'simpleray.Vector3f', $simpleray_Vector3f, Object);
Type.registerClass(global, 'System.Color', $System_Color, Object);
Type.registerClass(global, 'System.Console', $System_Console, Object);
Type.registerClass(global, 'System.Random', $System_Random, Object);
Type.registerClass(global, 'System.Stopwatch', $System_Stopwatch, Object);
Type.registerClass(global, 'System.Drawing.Bitmap', $System_Drawing_Bitmap, Object);
Type.registerClass(null, 'simpleray.$Plane', $simpleray_$Plane, $simpleray_RTObject);
Type.registerClass(null, 'simpleray.$Sphere', $simpleray_$Sphere, $simpleray_RTObject);
