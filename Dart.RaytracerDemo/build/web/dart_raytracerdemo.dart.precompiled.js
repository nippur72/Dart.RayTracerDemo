...
["", "SimpleRaytracer.const.dart", , Y, {
  ...
  RayTracer_ReportSpeed: function(msPerPixel) {
    ...
    for (t1 = $.RayTracer_speedSamples, t1 = new H.ListIterator(t1, t1.length, 0, null), average = 0; t1.moveNext$0();) {
      d = t1._current;
      if (typeof d !== "number")
        return H.iae(d);
      average += d;
...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  IsolateNatives__startNonWorker_closure: {
    "^": "Closure:37;box_0,functionName_1,isSpawnUri_2,startPaused_3,replyPort_4",
    call$0: [function() {
      var t1 = this.box_0;
...
function dart_precompiled($collectedClasses) {
  ...
  Vector3f.builtin$cls = "Vector3f";
  if (!"name" in Vector3f)
    Vector3f.name = "Vector3f";
  $desc = $collectedClasses.Vector3f;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Vector3f.prototype = $desc;
  Vector3f.prototype.get$x = function(receiver) {
    return this.x;
  };
  Vector3f.prototype.get$y = function(receiver) {
    return this.y;
  };
  Vector3f.prototype.get$z = function(receiver) {
    return this.z;
  };
  ...
  Light.prototype.get$position = function(receiver) {
    return this.position;
  };
  function Ray(origin, direction, closestHitObject, closestHitDistance, hitPoint) {
    this.origin = origin;
    this.direction = direction;
    this.closestHitObject = closestHitObject;
    this.closestHitDistance = closestHitDistance;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Ray.prototype = $desc;
  function RTObject(color) {
    this.color = color;
  }
  RTObject.builtin$cls = "RTObject";
  if (!"name" in RTObject)
    RTObject.name = "RTObject";
  $desc = $collectedClasses.RTObject;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RTObject.prototype = $desc;
  RTObject.prototype.get$color = function(receiver) {
    return this.color;
  };
  ...
  Sphere.prototype.get$position = function(receiver) {
    return this.position;
  };
  function Plane(normal, distance, color) {
    this.normal = normal;
  ...
  function RayTracer_RenderRow_closure(canvas_0, dotPeriod_1, y_2) {
    this.canvas_0 = canvas_0;
    this.dotPeriod_1 = dotPeriod_1;
    this.y_2 = y_2;
  }
  RayTracer_RenderRow_closure.builtin$cls = "RayTracer_RenderRow_closure";
  if (!"name" in RayTracer_RenderRow_closure)
    RayTracer_RenderRow_closure.name = "RayTracer_RenderRow_closure";
  $desc = $collectedClasses.RayTracer_RenderRow_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RayTracer_RenderRow_closure.prototype = $desc;
  ...
  function Bitmap(_width, _height, _canvas, _context, _imagedata) {
    this._width = _width;
  ...
  function MersenneTwister(_mt) {
    this._mt = _mt;
  }
  MersenneTwister.builtin$cls = "MersenneTwister";
  if (!"name" in MersenneTwister)
    MersenneTwister.name = "MersenneTwister";
  $desc = $collectedClasses.MersenneTwister;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MersenneTwister.prototype = $desc;
  function Random(mt) {
    this.mt = mt;
  }
