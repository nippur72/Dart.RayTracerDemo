...
import io.github.timeu.javagwtraytracerdemo.server.util.Bitmap;
import io.github.timeu.javagwtraytracerdemo.server.util.Console;
import io.github.timeu.javagwtraytracerdemo.server.util.Random;
...
public class RayTracer {
    ...
    static void RenderRow (final Bitmap canvas, final int dotPeriod, final int y) {        
		if (y >= CANVAS_HEIGHT) {
           ...
           else                       Console.WriteLine("checksum error:"+Double.toString(checkNumber));                           
           return;
        }
    ...
    static void SetTimeout (int timeoutMs, final TimerTask action) {
